...
@section('sellertitle','Edit Product Upload')
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="custom-form">
				<form action="{{url('auth/me/seller/update/product')}}" method="POST" enctype="multipart/form-data" name="editForm">
				@csrf 
					@php
					...
					<div class="row">
						...
						<!-- col end -->
	                     ...
	                     <!-- <div class="col-md-4 col-sm-6">
	                        ...
	                        <label for="title">Product Tag</label>
	                            <select name="producttag[]" class="form-control select2{{ $errors->has('producttag') ? ' is-invalid' : '' }} custom-select" multiple="multiple">
	                               @foreach($totaltags as $totaltag)
                                  <option value="{{$totaltag->id}}" @foreach($productTags as $selecttag) @if($totaltag->id == $selecttag->tag_id)selected="selected"@endif @endforeach>{{$totaltag->name}}</option>
                              	@endforeach
	                            </select>
						...
						<div class="col-md-12 col-sm-12">
							<div class="form-group">
								<label for="productdetails">Product Description <span>*</span></label>
						...
						<div class="col-md-12 col-sm-12">
							<div class="form-group">
								...
								<textarea type="text" name="productdetails2" class="textarea form-control{{ $errors->has('productdetails2') ? ' is-invalid' : '' }}"  id="productdetails2" value="{{ old('productdetails2') }}" required>{!! $edit_data->productdetails2 !!}</textarea>
