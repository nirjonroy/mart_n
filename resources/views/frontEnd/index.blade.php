                ...
                <div class="carousel-inner" role="listbox">
                    @foreach($sliders as $key=>$value)
                        <div class="item {{ $loop->first ? ' active' : '' }}" >
                            <img src="{{asset($value->image)}}"  style="width: 100%; height: 500px;" ">
                        </div>
                    @endforeach
                </div>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="slide-6 no-arrow ">
                    @foreach($homecategoryshow as $key=>$value)
                    <div>
                        <div class="category-contain">
                            <a href="{{url('category/'.$value->slug.'/'.$value->id)}}">
                                <div class="img-wrapper">
                                    <img src="{{asset($value->image)}}" alt="category-img" class="img-fluid">
                                </div>
                                <div>
...
<?php 
         $all_MasonaryBanar_info = DB::table('tbl_masonary')
                                   ->where('publication_status', 1)
                                        ->limit(8)
                                        ->get();
                            ...
                            <div class="col-md-12">
                                <div class="masonary-banner-main">
                                    <div class="masonory-banner-img">
                                        <img src="{{$v_MasonaryBanar->masonary_image}}" class="img-fluid bg-img" alt="masonory-banner">
                                    </div>
                                    <div class="masonary-banner-contant p-center">
                                        <a href="{{$v_MasonaryBanar->masonary_link}}"><h5>{{$v_MasonaryBanar->masonary_name}}</h5></a>
                                    </div>
                                </div>
                            </div>
...
<section class="section-py-space ratio_square ">
    <div class="custom-container addtocart_count">
        ...
        <div class="row">
                         @php
                      $homeproducts = App\Product::where(['productcat'=>$homecategory->id,'status'=>1])->orderBy('id','DESC')->limit(63)->get();
                        @endphp
                                ...
                                <div>
                                    ...
                                    <div class="product-box ">
                                        ...
                                        <div class="product-detail detail-center1">
                                            ...
                                            <h6>{{str_limit($value->productname,20)}}</h6>
                                            <span class="detail-price">{{$value->productoldprice}}<span>{{$value->productnewprice}}</span></span>
                                        </div>
                                        <div class="addtocart_btn">
                                            <button class="add-button add_cart" title="Add to cart">
                                                add to cart
