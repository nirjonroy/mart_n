...
<div style="width:865px;margin: 0 auto;padding: padding:100px;">
	<div>
		<h2 style="color:#222">Congratulation! Account Verified - <span style="color:orange">Mart9294</span></h2>
	</div>
	<div style="border: 1px solid #ddd;">
		...
		<div style="padding: 0 30px;width: 700px;margin: 0 auto;">
			<div class="basic-info">
				...
				<p style="color:#222;font-size: 16px;"> Congratulation! Your account has been verified with <strong style="color:orange">Mart9294</strong>.<span>Please Verify Your <br> Email</span> <a href="{{url('customer/email/verify/'.$customerid.'/'.$verifyToken)}}" style="text-decoration: none;padding: 5px;color:blue;
"><strong>CLICK HERE</strong></a> </p>
        <p style="color:#222;font-size: 16px;">Your useremail and password are :</p>
				<p style="color:#222;font-size: 16px;text-decoration: none"> User Email : <a style="text-decoration: none;color:#222 !important">{{$email}}</a></p>
				<p style="color:#222;font-size: 16px;"> Password : {{$password}}</p>
				<p style="color:#222;font-size: 16px;">Enjoy Shopping with us.We look forward to seeing you soon</p>
				<p style="color:#222;font-size: 16px;">If you need any help, please do not hesitate to contact with us at</p>
				<p style="color:#222;font-size: 16px;"><a href="mailto:support@mart9294.com" style="color:black">support@mart9294.com</a> or call us on 017xxx.</p>
			</div>
