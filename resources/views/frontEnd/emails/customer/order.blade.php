...
<div style="width:865px;margin: 0 auto;padding: padding:100px;">
	<div>
		<h2 style="color:#222">Your order has been Received – <span style="color:orange">Mart9294</span></h2>
	</div>
	<div style="border: 1px solid #ddd;">
		<div style="background:#222;width: 700px;padding: 25px 15px;margin: 0 auto;overflow: hidden;">
			<h1 style="color:#fff;float:left;margin-left: 25px;">New Order</h1>
		...
		<div style="padding: 0 30px;width: 700px;margin: 0 auto;">
			<div class="basic-info">
				...
				<p style="color:#222;font-size: 16px;"> Thank you for your order. Just to let you know —we've received your order # and it is waiting for confirmation:</p>
				<p style="color:#222;font-size: 16px;">Please review your products and let us know if you want to amend anything         Our customer care executive will contact with you in a while</p>
