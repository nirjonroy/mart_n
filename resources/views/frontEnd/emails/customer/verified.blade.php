...
<div style="width:865px;margin: 0 auto;padding: padding:100px;">
	...
	<div style="border: 1px solid #ddd;">
		<div style="background:#222;width: 700px;padding: 25px 15px;margin: 0 auto;overflow: hidden;">
			<h1 style="color:#fff;float:left;margin-left: 25px;">Account Verified</h1>
		...
		<div style="padding: 0 30px;width: 700px;margin: 0 auto;">
			<div class="basic-info">
				...
				<p style="color:#222;font-size: 16px;"> Congratulation! Your account has been verified with <strong style="color:orange">Mart9294</strong>. Your useremail and password are: </p>
				...
				<p style="color:#222;font-size: 16px;"><a href="mailto:support@mart9294.com.bd" style="color:black">support@mart9294.com.bd</a> or call us on 017xxx.</p>
			</div>
