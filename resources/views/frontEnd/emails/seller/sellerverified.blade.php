...
<div style="width:865px;margin: 0 auto;padding: padding:100px;">
	<div>
		<h2 style="color:#222">Sign Up Email - <span style="color:orange"></span></h2>
	</div>
	<div style="border: 1px solid #ddd;">
		...
		<div style="padding: 0 30px;width: 700px;margin: 0 auto;">
			<div class="basic-info">
				...
				<p style="color:#222;font-size: 16px;"> Congratulation! Your merchant account has been verified with <strong style="color:orange">MART9294</strong>.
				</p>
				<p style="color:#222;font-size: 16px;">Your useremail and password are :</p>
				<p style="color:#222;font-size: 16px;text-decoration: none"> User Email : <a style="text-decoration: none;color:#222">{{$email}}</a></p>
				<p style="color:#222;font-size: 16px;"> Password : <span style="font-weight:600">{{$password}}</span></p>
				...
				<p style="color:#222;font-size: 16px;"><a href="mailto:support@mart9294.com" style="color:black">support@mart9294.com</a> or call us on 017xxxxx.</p>
			</div>
