                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="from-group">
                                  ...
                                  <input type="file" name="logo" id="logo" class="form-control{{ $errors->has('logo') ? ' is-invalid' : '' }}" value="{{ old('logo') }}" accept="logo/png">
                        ...
                        <div class="col-sm-12">
                            <div class="from-group">
                              ...
                              <input type="file" name="faveicon" id="faveicon" class="form-control{{ $errors->has('faveicon') ? ' is-invalid' : '' }}" value="{{ old('faveicon') }}" accept="faveicon/png">
