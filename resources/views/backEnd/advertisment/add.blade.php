...
@section('title','advertisment Add')
@section('main_content')
<section class="content">
  <div class="container-fluid">
    <div class="card card-default">
      <div class="card-header">
          <h3 class="card-title">Add advertisment information</h3>
      ...
      <!--card-header -->
            <div id="form_body" class="card-body">
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="custom-bg">
                    <form action="{{url('admin/advertisment/save')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                              ...
                              <input type="url" name="link" class="form-control{{ $errors->has('link') ? ' is-invalid' : '' }}" value="{{ old('link') }}">
