      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <h3 class="card-title">Manage news information</h3>
      			<div class="short_button">
              <a href="{{url('admin/news/add')}}"><i class="fa fa-plus"></i>Add</a>
      			</div>
          </div>
          <!-- /.card-header -->
            <div class="card-body">
                  ...
                  <td>
                    <ul class="action_buttons dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li>
                        @if($value->status==1)
                        <form action="{{url('admin/news/inactive')}}" method="POST">
                          @csrf
                        ...
                        @endif
                          ...
                          <li>
                        <a class="edit_icon" href="{{url('admin/news/edit/'.$value->id)}}" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                      </li>
                      <li>
