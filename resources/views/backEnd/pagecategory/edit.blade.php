                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                             <div class="form-group">
                              ...
                              <input type="text" name="pagename" class="form-control{{ $errors->has('pagename') ? ' is-invalid' : '' }}" value="{{ $edit_data->pagename }}" placeholder="Ex. FAQ, term fo use ect.">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                              ...
                              <select name="menu_id" class="form-control select2 {{ $errors->has('menu_id') ? ' is-invalid' : '' }}" value="{{ old('menu_id') }}">
                                ...
                                <option value="1">Usefull Link</option>
                              </select>
