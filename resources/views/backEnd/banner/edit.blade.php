...
<section class="content">
      ...
      <!--card-header -->
            <div id="form_body" class="card-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="custom-bg">
                    <form action="{{url('/editor/banner/update')}}" method="POST" enctype="multipart/form-data" name="editForm">
                      @csrf
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                              <div class="form-group">
                                  <label for="text">Content</label>
                                    <textarea name="text" class="textarea form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" value="">{{ $edit_data->text }}</textarea>
                      ...
                      <!-- /.form-group -->
                       <div class="col-sm-6">
                            <div class="form-group">
                             ...
                             <input type="checkbox" name="frontpage" class="{{ $errors->has('frontpage') ? ' is-invalid' : '' }}" @if($edit_data->frontpage==1) checked="checked" @endif value="1">
  ...
  <script type="text/javascript">
      ...
      document.forms['editForm'].elements['posttype'].value="{{$edit_data->posttype}}"
