                ...
                <thead>
                  ...
                  <td>{{$loop->iteration}}</td>
                    ...
                    <td> <strong>Category: </strong>{{$value->catname}}<br>
                         <strong>Subcatgory: </strong>{{$value->subcategoryName}}<br>
                    </td>
                      ...
                      <ul class="action_buttons dropdown">
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <li>
                             ...
                             <a class="edit_icon" href="{{url('editor/seller/product/view/delete/'.$value->id)}}" title="View Details" ><i class="fa fa-edit"></i> Delete</a>
