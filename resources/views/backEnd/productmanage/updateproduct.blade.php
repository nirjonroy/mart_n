...
@section('title','Product Update Pending')
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <h3 class="card-title">Product Update Pending</h3>
          </div>
          <!-- /.card-header -->
            <div class="card-body user-border">
               <form action="{{url('editor/published/update-product-manage/bulk-option')}}" method="POST" id="myform">
                @csrf
