...
<section class="content">
    ...
    <div class="card card-default">
      ...
      <!--card-header -->
            <div id="form_body" class="card-body">
              <div class="row">
                <form action="{{url('editor/seller/product/update')}}" method="POST" enctype="multipart/form-data" name="editForm">
                    @csrf 
                      @php
                      ...
                      <div class="col-md-4 col-sm-6">
                        <div class="form-group">
                          <label for="productpoint">Product Point </label>
                          <input type="text" name="productpoint" class="form-control {{$errors->has('productpoint')? 'is-invalid' : ''}}" name="productpoint"  value="{{$edit_data->productpoint}}">                          </select>
                          @if($errors->has('productpoint'))
                              <span class="invalid-feedback" role="alert">
                                <strong>{{$errors->first('productpoint')}}</strong>
                              </span>
                          @endif
                        </div>
                      </div>
  ...
  document.forms['editForm'].elements['sellerid'].value="{{$edit_data->sellerid}}"
