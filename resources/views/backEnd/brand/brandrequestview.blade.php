  ...
  <div class="container-fluid">
    <div class="card card-default">
      <div class="card-header">
          <h3 class="card-title">Add Request information</h3>
      ...
      <!--card-header -->
            <div id="form_body" class="card-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="custom-bg">
                    <form action="{{url('/editor/brand/request/save')}}" method="POST" enctype="multipart/form-data" name="editForm">
                      @csrf
                                        ...
                                        @endphp
                                         <div class="ls-checkbox">
                                          <label class="cat-chechbox">
                                            <input type="checkbox"  @foreach($brandrequest as $brandcheck) @if($brandcheck->subcat_id==$subcategory->id) checked="checked" @endif @endforeach value="{{$subcategory->id}}" name="subcategory[]"> 
